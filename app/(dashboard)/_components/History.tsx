        ...
        <Card className="col-span-12 mt-2 w-full">
            ...
            <CardContent>
                <SkeletonWrapper isLoading={historyDataQuery.isFetching}>
                    {dataAvailable && (
                        <ResponsiveContainer width={"100%"} height={300}>
                            ...
                            >
                                ...
                                <CartesianGrid strokeDasharray="5 5" stroke="currentColor" strokeOpacity={"0.2"} vertical={false} />
                                <XAxis 
                                stroke="currentColor" 
                                fontSize={12} 
                                tickLine={false} 
                                ...
                                <Tooltip cursor={{fill: 'rgba(138, 135, 135, 0.2)'}} content={props =>(
                    ...
                    {!dataAvailable && (
                        <Card className="flex h-[300px] flex-col items-center justify-center bg-card">
