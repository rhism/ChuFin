...
function Overview({userSettings}: {userSettings: userSettings}) {
    ...
    return (
    <>
    <div className="relative flex flex-wrap items-end justify-between gap-2 py-6 px-8 pl-2">
        <h2 className="text-3xl pl-6 font-bold">Overview</h2>
        <div className="flex items-center gap-3">
            ...
            onUpdate={values => {
                ...
                // update the date range if only both date are set
